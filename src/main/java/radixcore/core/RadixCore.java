...
@Mod(modid = RadixCore.ID, name = RadixCore.NAME, version = RadixCore.VERSION, acceptedMinecraftVersions = "[1.12, 1.12.1]")
public class RadixCore 
{
	public static final String ID = "radixcore";
	public static final String NAME = "RadixCore";
	public static final String MINECRAFT_VERSION = "1.12.1";
