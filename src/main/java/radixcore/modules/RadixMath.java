...
public final class RadixMath
{
	...
	{
		return getDistanceToXYZ(entity.posX, entity.posY, entity.posZ, point.dX(), point.dY(), point.dZ());
	}

	public static double getDistanceToXYZ(Point3D point1, Point3D point2)
	{
		return getDistanceToXYZ(point1.dX(), point1.dY(), point1.dZ(), point2.dX(), point2.dY(), point2.dZ());
	}
